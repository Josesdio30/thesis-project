...
import { FaClock, FaUser, FaGraduationCap, FaSpinner, FaUserFriends, FaClipboard, FaPlus, FaEdit, FaTrash } from 'react-icons/fa';
...
const AddSessionModal = ({ isOpen, onClose, onSave }: {
  isOpen: boolean;
  onClose: () => void;
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    if (!formData.title || !formData.startTime || !formData.endTime || !formData.date || 
        !formData.courseCode || !formData.teacherId || !formData.classId || !formData.sessionNumber) {
